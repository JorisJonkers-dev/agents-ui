...
// SubmitRedirectUrlInput) flow through the published agents-api client.
//
...
import type {
  StartCredentialSessionRequest,
  SubmitRedirectUrlRequest,
} from '@jorisjonkers-dev/agents-api-client'

export type CredentialProvider = 'claude' | 'codex'

export type StartCredentialSessionInput = StartCredentialSessionRequest
export type SubmitRedirectUrlInput = SubmitRedirectUrlRequest
