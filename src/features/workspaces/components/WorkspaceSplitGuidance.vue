  ...
  >
    <div class="flex items-center gap-2">
      <button
        ...
        aria-controls="workspace-split-guidance-content"
        :aria-label="collapsed ? 'Expand split guidance' : 'Collapse split guidance'"
        data-testid="workspace-split-guidance-toggle"
    ...
    <div v-if="!collapsed" id="workspace-split-guidance-content">
