...
export type AgentSetupReference = AgentSetupReferenceResponse
...
export type AgentSetupCatalogEntry = AgentSetupCatalogEntryResponse

export type AgentSetupBinding = AgentSetupBindingResponse
export type AgentSetupValidationIssue = AgentSetupValidationIssueResponse
export type AgentSetupValidation = AgentSetupValidationResponse

export type SetupTargetOption = SetupTargetOptionResponse
export type SetupTargetOptions = SetupTargetOptionsResponse

export type AgentSetupDiffChange = AgentSetupDiffChangeResponse
export type AgentSetupDiff = AgentSetupDiffResponse
export type SetupPreview = SetupPreviewResponse
export type SessionSetupState = SessionSetupStateResponse
export type FailedSessionSetup = FailedSessionSetupResponse

export type SetupTransitionStatus = 'REQUESTED' | 'STARTED' | 'COMPLETED' | 'FAILED' | 'CANCELLED'

export type SetupTransition = SetupTransitionResponse
export type SetupTransitionHistory = SetupTransitionHistoryResponse
...
export type WorkspaceConnectResponse = AgentsWorkspaceConnectResponse
